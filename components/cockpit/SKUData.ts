...
export const approvalCards: ApprovalCard[] = [
  {
    id: "approval-1",
    title: "Approve Seasonal push allocation",
    segment: "Seasonal / Event",
    recommendation: "Push 42% of available Halloween décor inventory to high-velocity seasonal stores",
    whyApproval: "High revenue exposure and constrained inventory before the selling window",
    valueAtRisk: "$2.4M",
    owner: "Demand Planning + Allocation",
    status: "pending",
    primaryLabel: "Approve Push",
    secondaryLabel: "Review Details",
    drawer: {
      title: "Seasonal Push Allocation — Approval",
      status: "pending",
      explanation: "AI recommends pushing 42% of Halloween décor inventory to 1,240 high-velocity seasonal stores before the selling window opens. Delaying increases OOS risk and leaves $2.4M of revenue exposure unprotected.",
      signals: ["Store absorption score ≥ Q3", "Selling window: 5 weeks remaining", "Current OOS rate: 9.6%", "Allocation available: constrained"],
      metrics: [
        { label: "Inventory to push", value: "42% of available" },
        { label: "Target stores", value: "1,240" },
        { label: "Revenue at risk if delayed", value: "$2.4M" },
        { label: "Human approval needed", value: "Yes" },
      ],
      sourceTabs: [
        { label: "Inventory & Allocation", id: "inventory" },
        { label: "Demand Planning", id: "demand" },
      ...
      actionTabId: "inventory",
      extraSections: [
        { heading: "Risk if not approved", body: "Delayed push increases shelf OOS for Halloween décor through the peak selling window. Estimated revenue impact: $2.4M." },
        { heading: "Recommended next step", body: "Approve push and confirm store receipt readiness with Store Execution before shipping." },
      ],
    },
  },
  {
    id: "approval-2",
    title: "Approve Promo inventory protection",
    segment: "Promo / Merchant-Driven",
    recommendation: "Protect Party promo inventory for stores with confirmed display readiness",
    whyApproval: "Merchant calendar confirmation required before allocation lock",
    valueAtRisk: "$860K",
    ...
    drawer: {
      title: "Promo Inventory Protection — Approval",
      status: "pending",
  ...
  {
    id: "approval-3",
    title: "Review constrained SKU fallback",
    ...
    whyApproval: "Fill-rate constraint and DC capacity pressure limit the full recommendation",
    valueAtRisk: "$1.1M",
    ...
    drawer: {
      title: "Constrained SKU Fallback — Review",
      status: "needs-approval",
      explanation: "Cleaning SKUs from two constrained suppliers have an active fill-rate shortfall and DC capacity flag. AI recommends partial allocation with substitution where the primary SKU is unavailable.",
      signals: ["Supplier fill-rate: 71% (threshold: 85%)", "DC hold: active", "Substitution analogs: available", "Revenue exposure: $1.1M"],
      metrics: [
        { label: "Constrained SKUs", value: "28" },
        { label: "Supplier fill-rate", value: "71%" },
        { label: "Partial allocation coverage", value: "68%" },
        { label: "Substitution coverage", value: "22%" },
      ],
      sourceTabs: [
        { label: "Supplier & Inbound Flow", id: "supplier-inbound" },
        { label: "DC Capacity & Transportation", id: "dc-capacity" },
      ...
      extraSections: [
        { heading: "Risk if not approved", body: "Without fallback approval, 28 cleaning SKUs face zero allocation. Estimated shelf OOS impact: $1.1M across 420 stores." },
        { heading: "Recommended next step", body: "Approve partial allocation + substitution plan. Escalate fill-rate issue with Supplier Management." },
      ],
    },
  },
  {
    ...
    recommendation: "Push limited-buy home goods to high-absorption stores only",
    ...
    secondaryLabel: "View Analog Items",
    drawer: {
      title: "Treasure Hunt Controlled Push — Approval",
      status: "pending",
      explanation: "Home goods limited-buy SKUs have been matched to analogs with scores of 0.76–0.83. AI recommends pushing only to high-absorption stores to minimize markdown risk on a constrained one-time buy.",
      signals: ["Analog match: 0.76–0.83", "High-absorption stores only", "Markdown risk: moderate if overpushed", "One-time buy: no reorder"],
      metrics: [
        { label: "SKUs in push", value: "22" },
        { label: "Target stores", value: "High-absorption only (~800)" },
        { label: "Revenue at risk", value: "$640K" },
        { label: "Markdown risk if over-pushed", value: "High" },
      ],
      sourceTabs: [
        { label: "Inventory & Allocation", id: "inventory" },
        { label: "Demand Planning", id: "demand" },
      ...
      actionTabId: "inventory",
      extraSections: [
        { heading: "Risk if not approved", body: "Without push approval, limited-buy home goods sit in DC. Revenue opportunity of $640K is lost on a non-replenishable buy." },
        { heading: "Recommended next step", body: "Approve controlled push to high-absorption stores. Monitor sell-through in week 1 before any secondary push." },
      ],
    },
  },
]

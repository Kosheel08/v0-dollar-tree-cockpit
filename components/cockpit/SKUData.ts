...
export const summaryMetrics: {
  ...
  },
  {
    ...
    drawer: {
      ...
      sourceTabs: [
        ...
        { label: "Executive Decision Engine", id: "executive-tower" },
      ],
  ...
  },
  {
    ...
    drawer: {
      ...
      actionLabel: "Go to Executive Decision Engine",
...
export const decisionLog: {
  ...
  },
  {
    ...
    status: "needs-approval",
    relatedTab: { label: "Executive Decision Engine", id: "executive-tower" },
    ...
    drawer: {
      ...
      metrics: [
        ...
        sourceTabs: [{ label: "Executive Decision Engine", id: "executive-tower" }],
      actionLabel: "Go to Executive Decision Engine",
      actionTabId: "executive-tower",
    },
  },
...
export const approvalCards: ApprovalCard[] = [
  ...
  },
  {
    ...
    drawer: {
      ...
      sourceTabs: [
        { label: "SKU Strategy Segmentation", id: "sku-segmentation" },
        { label: "Inventory & Allocation", id: "inventory" },
      ],
      actionLabel: "Go to Inventory & Allocation",
      actionTabId: "inventory",

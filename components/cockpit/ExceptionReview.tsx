...
const exceptions = [
  {
    title: "Seasonal demand spike not captured",
    category: "Seasonal",
    region: "Southeast",
    severity: "Critical",
    rootCause: "Promotion lift and weather-driven demand exceeded baseline assumptions",
    impact: "$2.4M revenue at risk · 38 stores exposed",
    confidence: "High",
    decision: "Approve temporary forecast uplift of +12%",
    primaryBtn: "Approve Uplift",
    secondaryBtn: "Send to Planner",
  },
  {
    title: "Consumables replenishment demand under-forecast",
    category: "Consumables",
    region: "Midwest",
    severity: "Critical",
    rootCause: "Recent velocity acceleration across high-frequency pantry SKUs",
    impact: "$1.7M revenue at risk · 27 stores exposed",
    confidence: "Medium",
    decision: "Increase 4-week forecast by +6%",
    primaryBtn: "Apply Adjustment",
    secondaryBtn: "Review Details",
  },
  {
    title: "Party promotion uncertainty",
    category: "Party",
    region: "Northeast",
    severity: "Watchlist",
    rootCause: "Circular promotion timing shifted from prior planning cycle",

      ...
      <div className="flex items-start justify-between gap-8">
        <div className="flex-1 min-w-0">
          ...
          <p className="text-sm text-muted-foreground leading-relaxed mb-4">
            AI-driven SKU segmentation allows Dollar Tree to apply different planning and fulfillment strategies based on how each SKU behaves. Stable everyday SKUs can be replenished with higher automation, while seasonal, promotional, limited-buy, and constrained SKUs receive more targeted push strategies or human approval. This reduces planning noise and focuses planner attention on the SKU families where timing, availability, capacity, or confidence creates the greatest business risk.
          </p>
